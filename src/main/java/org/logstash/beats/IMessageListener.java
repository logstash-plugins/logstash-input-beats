...
/**
 * This interface is implemented in ruby in `lib/logstash/inputs/beats/message_listener`,
 * this class is used to link the events triggered from the differents connection to the actual
