...
**Beats.** If you are shipping events that span multiple lines, you need to use
...
**Elastic Agent.** Early releases of Elastic Agent and Fleet have some limitations, including support for advanced Beats settings like multiline, processors, and so forth. 
